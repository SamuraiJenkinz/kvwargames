...
Attempted to invoke `mcp__stitch__*` MCP tools to generate dark-themed game layout directionals. The tools are not available in this execution environment.
